  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gradient-to-br from-pink-100 to-purple-100">
      ...
      <div className="flex-grow flex flex-col">
        <Header />
        <main className="flex-grow flex flex-col gap-4 md:gap-10 justify-center items-center p-2 sm:p-4">
...
const LoadingUI = () => {
  return (
    <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
      <div className="card bg-white w-full h-[24rem] sm:h-[28rem] rounded-lg overflow-hidden border border-gray-200 shadow-sm">
